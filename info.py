...
BOT_TOKEN = environ.get('6883281957:AAFwA7R7ULuVnbSvZhy4hFUYav0FcKNOepM', '')
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://tatop53533:Nm123456@manish.wnnuk1j.mongodb.net/?retryWrites=true&w=majority', "")
DATABASE_NAME = environ.get('Manish', "PIRO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'FILES')

# Others
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('-1002034507638', '0').split()]
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('-1002032433259', '')).split()]
